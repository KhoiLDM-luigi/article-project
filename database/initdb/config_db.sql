...
VALUES ('article-server','default','master','server.port','8082'),
       ('article-server','default','master','spring.datasource.url','jdbc:postgresql://127.0.0.1:5433/article_db'),
       ('article-server','default','master','spring.datasource.username','psql'),
       ('article-server','default','master','spring.datasource.password','123'),
       ('article-server','default','master','spring.security.oauth2.resourceserver.jwt.issuer-uri','http://127.0.0.1:8081'),
       ('article-server','default','master','logging.level.org.springframework.security','DEBUG'),
       ('article-server','default','master','logging.level.root','INFO');
